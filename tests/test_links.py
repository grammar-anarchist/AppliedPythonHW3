...
def test_shorten_forbidden_alias():
    data = {
        "original_url": "https://google.com",
        "alias": "1234" 
    }
...
def test_delete_nonexistent(access_token):
...
def test_change_nonexistent(access_token):
...
def test_change_unauthenticated():
